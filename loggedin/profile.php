   ...
   ?>
    ...
    if (isset($_GET['upload'])){
      ...
      if ($_GET['error']=='bigfile'){
        echo '<div class="alert alert-danger" role="alert">The picture size is too big!</div>';
        ...
        echo '<div class="alert alert-danger" role="alert">Invalid png or jpeg!</div>';
      }
    }
     ?>
        </center>
