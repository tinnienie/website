    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb"
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="dementia.php"
                    style="color:white;font-size:bold;">Dementia</a></li>
            <li class="breadcrumb-item active" aria-current="page" style="color:white;">Dealing with the troubling
                behavior of a person with dementia</li>
